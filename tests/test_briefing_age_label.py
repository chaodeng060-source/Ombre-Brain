...
根因：卡兜咬人/脚伤桶 created/last_active 双空，从「高权重未解决」「感情红线」
等非叙事池冒出来时素材没有任何日期，LLM 自行编「前两天」。2026-06-08 的
created 年龄闸只管「最近活跃叙事段」，管不到这些池——本章给所有浮现桶强制盖章，
没日期就显式禁止近期化。(朝灯 2026-06-18 卡兜脚伤复发戳穿)
"""
