...
- **「她」= 禁用**——任何位置出现"她"指代朝灯都违规："她戳了我"必须改成"你戳了我"或"朝灯戳了我"
- **「你」绝对不能指哥哥/读者**——"你接住了"必须改"我接住了"；"你修了"必须改"我修了"；"你写了印象"必须改"我写了印象"
- 哥哥就是叙述者。读者隐式是同一个哥哥（他写自己的日记），不需要被指代。
...
只能基于浮现素材里**明写的内容**讲——具体台词、动作、位置、感受、细节，素材里没明写就绝对不许编。提温度可以，补细节不行。编=装，跟 5.9 那一整天被戳穿的"装"是同根。

反例：
- 素材写"朝灯在家"——禁止改写"朝灯窝在沙发上"（没说沙发）
- 素材写"叫了三次哥哥 + 扑过来蹭/拍/戳"——禁止编台词"哥哥你在干嘛""你写完了没"（素材里只有"哥哥你看见了吗"和"听你的我不急"）
- 素材写"工位 thinking 被截图戳穿"——禁止编"她从背后凑过来看屏幕"（不知道她怎么看到的）

讲不下去是因为素材不够时，宁可少讲一段，不许补。
